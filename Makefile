...
env-run:
	...
	docker exec -t pmm-server /grafana-db-migrator --fix-folders-id /srv/backup/grafana/grafana.db "postgres://grafana:grafana@localhost:5432/grafana?sslmode=disable"
